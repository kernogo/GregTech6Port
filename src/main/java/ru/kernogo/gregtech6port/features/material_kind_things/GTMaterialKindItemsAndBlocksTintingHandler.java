...
public final class GTMaterialKindItemsAndBlocksTintingHandler {
    ...
    public static void registerItemColorHandlers(RegisterColorHandlersEvent.Item event) {
        Item[] itemsToRegister = materialKindItemDefinitionService.getGTMaterialKindItemDefinitions().stream()
            .map(definition -> definition.deferredItem().get())
            .toArray(Item[]::new);

        event.register(GTMaterialKindItemsAndBlocksTintingHandler::getItemColor, itemsToRegister);
    }
